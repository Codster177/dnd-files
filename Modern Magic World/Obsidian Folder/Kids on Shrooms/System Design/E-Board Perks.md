...
| Lifting Big (Purchasable Twice) | Description                                                                               |
| ------------------------------- | ----------------------------------------------------------------------------------------- |
| Hitting Legs and Brains         | Upon unlocking this perk, gain 6 points to allocate to your stat modifiers.               |
| Getting Juiced Up               | Upon unlocking this perk, gain 4 points to allocate to your magic stat modifiers.         |
| Feeling the Pump                | At the beginning of a session, you gain 1D4 inspiration to spend before the session ends. |
## Level 20:

| One with the World | Description                                                                                                                                                                                                                        |
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Inner Peace        | When unlocking this perk, choose one of your stats. The stat you chose now has a natural 1 count as an the max die roll, allowing it to explode on natural 1s. In this case, a nat 1 on a D6 would also count as a 6, and explode. |
|                    |                                                                                                                                                                                                                                    |
